...
class Mustaches {
    ...
    async interpolate({ source, destination, name, data, resolver, formatters = {}, export: exportType }) {
        ...
        const requestsToInsert = await interpolation_1.insertTableRowsQuery(doc, data, resolver);
        ...
        const requeststoUpdateValues = await interpolation_1.updateTableRowsQuery(doc, data, resolver);
